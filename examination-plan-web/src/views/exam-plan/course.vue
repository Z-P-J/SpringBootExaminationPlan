<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="日期编码" align="center" prop="timeId" />
    ...
    ></el-pagination>
    <exam-course-detail-dialog v-model="courseDialog"></exam-course-detail-dialog>
  </div>
</template>
<script>
import {
...
import ExamCourseDetailDialog from './exam-course-detail-dialog'

export default {
  components: {
    ExamCourseDetailDialog
  },
  created() {
  ...
  data() {
    ...
    return {
      ...
      tempCourse: {
        ...
        timeId: '1',
        examDate: '2020-01-01',
        startTime: new Date(2020, 1, 1, 10, 0),
