    ...
    <div class="filter-container">
      ...
      <el-row :gutter="18">
        ...
        <el-form-item label="专业编码" prop="major_id">
          <el-input v-model="tmpData.major_id" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
      ...
      <el-form-item label="专业名称"><el-input v-model="tmpData.major_name" /></el-form-item>
        ...
        <el-col :span="12">
      <el-form-item label="总学分"><el-input v-model="tmpData.total_credit"  type="number"/></el-form-item></el-col>
      </el-row>
      <el-row :gutter="18">
      <el-col :span="8">
...
import { addApproveMajor } from '@/api/approve_major'
...
export default {
  ...
  methods: {
    ...
    addMajor() {
      ...
      addApproveMajor(this.tmpData, this.school_id).then(() => {
        this.$message.success('添加成功')
