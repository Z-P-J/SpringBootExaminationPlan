...
-- Records of account
-- ----------------------------
INSERT INTO `account` VALUES (1, '123456@qq.com', 'admin', 'admin123', '2019-07-01 00:00:00', '2020-06-23 18:00:58');
...
-- ----------------------------
INSERT INTO `course_info` VALUES ('00001', '00001', '英语', '英语课程', '全国命题', '正常', 3, 60, '100分制', 40, 60, 100, 120, 0, '理论', '');
...
INSERT INTO `course_info` VALUES ('00005', '00005', '数学', '数学课程', '全国命题', '正常', 3, 60, '100分制', 40, 60, 100, 120, 0, '理论', '无');
...
CREATE TABLE `exam_course`  (
  ...
  `time_id` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
...
CREATE TABLE `exam_info`  (
  ...
  `exams_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  `jihua_exams_status` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  `kaowu_exams_status` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  `kaoji_exams_status` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `major_categories` VALUES ('0', '一级学科', '工学');
INSERT INTO `major_categories` VALUES ('1', '一级学科', '理学');
INSERT INTO `major_categories` VALUES ('2', '一级学科', '社会学');
...
CREATE TABLE `major_info`  (
  ...
  `national_major_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `major_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `major_brief_introduction` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
  `major_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `education_level` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `exam_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `main_target_school` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `first_exam_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `approve_num` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `stop_freshman_registration_exam_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `stop_registration_num` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `stop_apply_exam_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `stop_apply_num` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  ...
  `major_category_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `major_info` VALUES ('A000001', '001', '汉语言', '暂无介绍', '本科段', '本科', '面向社会', '四川大学', '2', '000', '000', '000', '000', '000', '2020-06-23', '000', '正常', 200, 170, 50, 1, '1', '000', '毕业学分达到要求', '000');
INSERT INTO `major_info` VALUES ('A000002', '002', '法学', '暂无介绍', '本科段', '本科', '面向社会', '四川大学', '1', '000', '000', '000', '000', '000', '2020-06-23', '000', '即将停考', 200, 170, 50, 1, '1', '000', '毕业学分达到要求', '000');
INSERT INTO `major_info` VALUES ('A100000', 'D000', '测试专业', '后续补充介绍', '本科段', '本科', '面向高校', '四川大学', '001', 'BS001', '000', '000', '000', '000', '2022-12-31', '000', '正常', 200, 110, 55, 1, '1', '暂无', '暂无', '暂无');
INSERT INTO `major_info` VALUES ('Y000003', '003', '计算机科学', '暂无介绍', '本科段', '本科', '面向社会', '四川大学', '1', '000', '000', '000', '000', '000', '2020-06-23', '000', '停考', 200, 170, 50, 1, '1', '000', '毕业学分达到要求', '000');
...
CREATE TABLE `major_plan_adjust_apply`  (
  ...
  `approver` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
...
CREATE TABLE `major_plan_version`  (
  ...
  `plan_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
