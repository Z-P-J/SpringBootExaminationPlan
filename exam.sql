...
-- ----------------------------
INSERT INTO `course_info` VALUES ('00001', '00001', '英语', '英语课程', '全国命题', '0', 0, 0, '100分制', 0, 0, 0, 0, 0, '理论', '无');
...
CREATE TABLE `exam_info`  (
  ...
  `time_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `major_direction` VALUES ('00001', '00001', '11111', 3);
...
CREATE TABLE `major_info`  (
  ...
  `national_major_code` varchar(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
...
CREATE TABLE `pro_course_info`  (
  `major_id` varchar(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `course_id` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  `course_attr` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  `course_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  `exam_method` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  `exam_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  `direction_id` varchar(9) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  `notes` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  PRIMARY KEY (`major_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_czech_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `school_info`  (
  ...
  `school_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  `school_address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  `school_postcode` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  `school_phone` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `school_info` VALUES ('00001', '四川大学', '', '612500', '12580', '', '暂时院校信息');
...
INSERT INTO `school_info` VALUES ('00005', '四川大学1', '', '612500', '12580', '', '暂时院校信息');
...
INSERT INTO `school_info` VALUES ('00009', '四川大学2', '', '612500', '12580', '', '暂时院校信息');
